/**
 * This component was adapted from `simplemde`:
 *   github.com/sparksuite/simplemde-markdown-editor
 *
 * It is nearly identical to `simplemde`, but with the addition of these addons:
 *  - active-line
 *  - matchbrackets
 *  - closebrackets
 *  - foldcode
...
const Hermes = require('../../../../utils/hermes').default
...
function SimpleMDE(options) {
  ...
  if (options.element) {
    ...
    logger.warn('SimpleMDE: Error. No element was found.')
    return
  }
...
SimpleMDE.prototype.render = function(el) {
  ...
  this.codemirror = CodeMirror.fromTextArea(
    el,
    Object.assign(SIMPLE_MDE_OPTIONS, {
      mode,
      backdrop,
      theme: 'paper',
...
SimpleMDE.prototype.autosave = function() {
  if (isLocalStorageAvailable()) {
    ...
    if (
      ...
      logger.warn('SimpleMDE: You must set a uniqueId to use the autosave feature')
      return
    }
    ...
    logger.warn('SimpleMDE: localStorage not available, cannot autosave')
  }
}
...
SimpleMDE.prototype.clearAutosavedValue = function() {
  if (isLocalStorageAvailable()) {
    if (
      ...
      logger.warn('SimpleMDE: You must set a uniqueId to clear the autosave value')
      return
    }
